...
\noindent But most of the time it's enough to use just a \q{super.key}-declaration by inheriting from another widget.
This approach is useful in scenarios where the key of the parent widget already serves the identification and 
