...
Regarding the deployment procedure, while we are following a "no-server"-approach, which means there is no any dedicated 
server to deploy into, we can improve the usage of our GitHub Pages (\ref{a-badges}):
