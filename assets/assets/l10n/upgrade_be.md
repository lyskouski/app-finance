...
### 7.2.0
- Даданьне Грузінскай (KA) і Рускай (RU) моў

### 7.1.0
- Зводка бюджэту: магчымасць ігнараваць адмоўныя значэньні
- Падзяліць рахунак
- Біяметрычная аўтэнтыфікацыя

### 7.0.2
- Палепшаная галоўная старонка як для вялікіх, так і для малых экранаў

### 6.7.0
- Сартаваньне бюджэту/рахункаў па назве, даце і суме
- Бюджэт > Зводка: опцыі, якія можна націскаць, для праверкі рахункаў за пэўны інтэрвал

### 6.6.1
- Бяспека: Даданьне абароны аднаразовым паролем
