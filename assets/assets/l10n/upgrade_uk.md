...
### 7.2.0
- Додавання Грузинської (KA) та Російської (RU)

### 7.1.0
- Звіт про бюджет: можливість ігнорувати від’ємні значення
- Розподіл рахунку
- Біометрична аутентифікація

### 7.0.2
- Вдосконалено головну сторінку для великих і малих екранів

### 6.7.0
- Сортування бюджету/рахунків за назвою, датою та сумою
- Бюджет > Звіт: клікабельні опції для перевірки рахунків за певний період

### 6.6.1
- Безпека: додавання захисту одноразовим паролем
