...
sizes and pixel ratios, thereby ensuring a comprehensive assessment of its adaptive design alignments \issue{179}{}.
To generate images (\cref{img:t-images}) for further assertion it's used \q{test}-command with an extra 
\q{update-goldens}-parameter, while inside the tests verification and generation is solely controlled by
...
testWidgets('', (WidgetTester tester) async {
  ...
  // As an alternative for tearDown
  addTearDown(() {
