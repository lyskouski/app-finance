...
### 7.2.0
- اضافه کردن گرجی (KA) و روسی (RU)

### 7.1.0
- خلاصه بودجه: گزینه نادیده گرفتن مقادیر منفی
- تقسیم صورت‌حساب
- احراز هویت بیومتریک

### 7.0.2
- بهبود صفحه اصلی برای صفحه‌های نمایش بزرگ و کوچک

### 6.7.0
- مرتب‌سازی بودجه/حساب بر اساس نام، تاریخ و مبلغ
- بودجه > خلاصه: گزینه‌های قابل کلیک برای بررسی قبوض در یک بازه زمانی

### 6.6.1
- امنیت: افزودن محافظت با رمز عبور یک‌باره
