...
\begin{itemize}
\item \q{Fingrom} -- open-sourced financial accounting application.\\
\href{https://github.com/lyskouski/app-finance}{https://github.com/lyskouski/app-finance}

\item \q{Dart Class Wrapper} -- for a partial classes mocking for a unit testing.\\
...
\item \q{Vaviorka} --  comments (and \q{.feature}-files notation) interpreter.\\
