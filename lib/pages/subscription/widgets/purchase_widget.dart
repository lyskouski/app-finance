...
class PurchaseWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cost = product?.rawPrice.toCurrency(code: product?.currencyCode, withPattern: false) ?? '---';
            ...
            GridItem(
              ...
              child: Container(
                  ...
                  child: RowWidget(
                    ...
                    maxWidth: size - indent * 2,
                    children: [
                      [
                        Align(
                            alignment: Alignment.centerLeft,
                            child: TextWrapper(title, maxLines: 2, style: context.textTheme.bodySmall)),
                      ],
                      [
                        Align(
